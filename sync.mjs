...
//        $env:SF_API_KEY = "iaOBKvkCdYyzqwIx3c795hyp5kLbS9tc"
//        $env:SF_COMPANY_ID = "115311"
//        $env:SUPABASE_URL = "https://xxxx.supabase.co"
//        $env:SUPABASE_SERVICE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRodmN2Zm1xenFxeGNtY3dvd3doIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MjMyNTM5OSwiZXhwIjoyMDk3OTAxMzk5fQ.uV-tKdAmRATrW4Cd7fYqgIspGCDaEq87zpTTC0lSyuk"
//   3) node sync.mjs
//
    ...
    for (const r of recs) {
      ...
      if (type === "order") {
        orders.push({
          ...
          items_summary: inv.items_name || (r.InvoiceItem || []).map((it) => it.name).filter(Boolean).join(", ") || null,
